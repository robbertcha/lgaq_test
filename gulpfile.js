...
// compile image into build js
gulp.task('build-images-dev', function() {
  gulp.src([paths.docs + 'assets/img/*.{gif,jpg,png,svg}'])
      .pipe(gulp.dest('./build/assets/img'));
});

gulp.task('watch', function() {
  gulp.watch(paths.img +'*.{gif,jpg,png,svg}', ['build-images-dev']);
});
...
gulp.task('js', function(){
    return gulp.src(paths.docs +'assets/js/script.js')
        .pipe(sourcemaps.init())
